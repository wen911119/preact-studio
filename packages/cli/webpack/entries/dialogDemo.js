    ...
    if (typeof App === 'function') {
      let init = () => {
        let _app = require('/Users/user/Documents/preact-studio/packages/demo/src/pages/dialogDemo/app.js')
          .default
      ...
      if (module.hot)
        module.hot.accept(
          '/Users/user/Documents/preact-studio/packages/demo/src/pages/dialogDemo/app.js',
          init
        )
      init()
    }
