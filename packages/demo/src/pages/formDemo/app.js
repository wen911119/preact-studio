...
import FormActionSheet from '../../components/FormActionSheet'
    ...
    return (
      <div>
        <Form ref={form => (this.form = form)}>
          ...
          <Form.Field label='手机号' field='phone' validate={[required, phoneCheck]}>
            <FormNumberInput limit={11} placeholder='请输入手机号' />
          </Form.Field>
